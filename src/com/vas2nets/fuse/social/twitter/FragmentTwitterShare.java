 ...
 * 
 */
public class FragmentTwitterShare extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		final View view = inflater.inflate(R.layout.fragment_fragment_twitter_share, container, false);
		
		commentTxtView = (TextView) view.findViewById(R.id.twittercommenteditText);
		wordCountTxt = (TextView) view.findViewById(R.id.twitterwordcounter);
		shareButton = (ImageView) view.findViewById(R.id.twittershareimageView);
		userImage = (ImageView) view.findViewById(R.id.twitteruserimageView);
		
		adapter = new SocialAuthAdapter(new MyResponseListener());
	...
	private final class MyResponseListener implements DialogListener {
